...
if ((sessionStorage.getItem('session') === null || sessionStorage.getItem('session')=="undefined") && (localStorage.getItem('session')===null || localStorage.getItem('session')=="undefined")) {
            ...
            success:function(ResponseBody){
                ...
                if (ResponseBody.emailConfirmed) {
                    ...
                    $.ajax({
                        ...
                        method: 'POST',
                        dataType: 'json',
                        data: JSON.stringify({ 'confirmationEndpoint': 'https://www.pennyinc.co.ke/confirmEmail.html', 'appName': 'Penny Inc' }),
	...
	$("#bonusL").click(function () {
		...
		$.ajax({
			...
			complete:function(){
				...
				$.ajax({
					url:'https://pennycoreapi.azurewebsites.net/Auction/GetAuctions?state=ACTIVE&category=3a3f8c99-04da-4dc1-8087-d2d8b88a4b70',
					method:'Get',
					dataType:'json',
					headers:{
						'Content-Type':'application/json',
					...
					data:{'state':'ACTIVE','category':'3a3f8c99-04da-4dc1-8087-d2d8b88a4b70'},
					success:function(ResponseBody){
						console.log(JSON.stringify(ResponseBody));
	...
	$("#ClosedA").click(function(event){
		event.preventDefault();
	$.ajax({
					url:'https://pennycoreapi.azurewebsites.net/Auction/GetAuctions?state=CLOSED&category=3a3f8c99-04da-4dc1-8087-d2d8b88a4b70',
					method:'Get',
					dataType:'json',
					headers:{
						'Content-Type':'application/json',
					...
					data:{'state':'CLOSED','category':'3a3f8c99-04da-4dc1-8087-d2d8b88a4b70'},
					success:function(ResponseBody){
						console.log(JSON.stringify(ResponseBody));
						$("#content").empty();
						ResponsePC = JSON.parse(JSON.stringify(ResponseBody));
